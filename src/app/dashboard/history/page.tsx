                  ...
                  <thead className="bg-green-600">
                    <tr>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">
                        ...
                        />
                        <span className="ml-2">{t.history.allLabel}</span>
                      </th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.hashHeader}</th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.clientHeader}</th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.createdDateHeader}</th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.dateOfLastAttackHeader}</th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.letterFilesHeader}</th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.ppamsStatusHeader}</th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.numberOfFilesHeader}</th>
                      <th className="whitespace-nowrap px-2 py-2 text-left text-xs font-medium uppercase tracking-wider text-white sm:px-4 sm:py-3">{t.history.actionsHeader}</th>
                    </tr>
                  </thead>
